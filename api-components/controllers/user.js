                                    ...
                                    Country.findOne({ _id: country_id }).then((country) => {
                                        ...
                                        City.findOne({ _id: city_id }).then((city_detail) => {
                                            if (city_detail) {
                                                ...
                                                if(!request_data_body.is_user_pick_up_order && !radius){
                                                    ...
                                                    if (request_data_body.vehicle_id) {
                                                        ...
                                                        query = { city_id: city_id, delivery_type: delivery_type, vehicle_id: vehicle_id, type_id: delivery_price_used_type_id,is_business:true };
                                                    } else {
                                                        query = { city_id: city_id, delivery_type: delivery_type, type_id: delivery_price_used_type_id,is_business:true }
                                                    }
